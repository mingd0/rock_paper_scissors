...
class TestGame(unittest.TestCase):
    ...
    def test_print_round_result_invalid_score(self):
        self.assertRaises(ValueError, Game.print_round_result, self, 'computer', 0, -1)

    def test_print_round_result_invalid_player(self): 
        self.assertRaises(ValueError, Game.print_round_result, self, 'invalid_entry', 0, 1)

    def test_check_player_validity(self):
        self.assertRaises(ValueError, Game.check_player_validity, self, 'invalid_entry')
    ...
    def test_game_logic(self): 
        ...
        for player_choice in choices: 
            for computer_choice in choices: 
                result.append(Game.game_logic(self, player_choice, computer_choice))
